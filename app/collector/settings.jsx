...
export default function CollectorSettingsScreen() {
  ...
  const { logout } = useCollectorAuth();
  const [notificationsEnabled, setNotificationsEnabled] = useState(true);
  const [locationEnabled, setLocationEnabled] = useState(true);
  const [darkModeEnabled, setDarkModeEnabled] = useState(false);
  const [autoRouteEnabled, setAutoRouteEnabled] = useState(true);
  const [collectionAlertsEnabled, setCollectionAlertsEnabled] = useState(true);
  ...
  const handleAbout = () => {
    Alert.alert(
      "About Gwaste",
      "Gwaste Collector App v1.0.0\n\nA smart waste management solution for collectors.\n\n© 2024 Gwaste. All rights reserved.",
      [{ text: "OK" }]
    );
  };
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <View style={styles.settingContent}>
                ...
                <Text style={styles.settingDescription}>Receive updates about routes and schedules</Text>
              </View>
            </View>
            <Switch
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <View style={styles.settingContent}>
                <Text style={styles.settingLabel}>Collection Alerts</Text>
                <Text style={styles.settingDescription}>Get notified about collection requests</Text>
              </View>
            </View>
            <Switch
              value={collectionAlertsEnabled}
              onValueChange={setCollectionAlertsEnabled}
              trackColor={{ false: '#E0E0E0', true: '#8BC500' }}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <View style={styles.settingContent}>
                ...
                <Text style={styles.settingDescription}>Allow location access for route tracking</Text>
              </View>
            </View>
            <Switch
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <View style={styles.settingContent}>
                <Text style={styles.settingLabel}>Auto Route</Text>
                <Text style={styles.settingDescription}>Automatically optimize collection routes</Text>
              </View>
            </View>
            <Switch
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            <View style={styles.settingInfo}>
              <Feather name="clock" size={20} color="#8BC500" />
              <View style={styles.settingContent}>
                <Text style={styles.settingLabel}>Working Hours</Text>
                <Text style={styles.settingDescription}>Set your availability</Text>
              </View>
            </View>
          ...
          <TouchableOpacity style={styles.settingItem}>
            <View style={styles.settingInfo}>
              <Feather name="truck" size={20} color="#8BC500" />
              <View style={styles.settingContent}>
                <Text style={styles.settingLabel}>Vehicle Info</Text>
                <Text style={styles.settingDescription}>Manage vehicle details</Text>
              </View>
            </View>
            <Feather name="chevron-right" size={20} color="#999" />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.settingItem}>
            <View style={styles.settingInfo}>
              <Feather name="map" size={20} color="#8BC500" />
              <View style={styles.settingContent}>
                <Text style={styles.settingLabel}>Route Preferences</Text>
                <Text style={styles.settingDescription}>Customize route settings</Text>
              </View>
            </View>
            <Feather name="chevron-right" size={20} color="#999" />
          </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            <View style={styles.settingInfo}>
              <Feather name="download" size={20} color="#8BC500" />
              <View style={styles.settingContent}>
                <Text style={styles.settingLabel}>Download Data</Text>
                <Text style={styles.settingDescription}>Export collection reports</Text>
              </View>
            </View>
            <Feather name="chevron-right" size={20} color="#999" />
          </TouchableOpacity>
